...
ontology = parser.parseFile("practice.owl")
...
fishypoke = elFactory.getConceptName('"FishyPoke"')

print()
print("I am first testing ELK.")
elk.setOntology(ontology)
print()
print("According to ELK, FishyPoke has the following subsumers: ")
subsumers = elk.getSubsumers(fishypoke)
...
subsumers = hermit.getSubsumers(fishypoke)
